            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link v-if="user.role=='teacher'" :href="route('teacher.dashboard')">
                                    <ApplicationLogo
                                        class="block h-9 w-auto fill-current text-emerald-800"
                                    />
                                </Link>
                                <Link v-if="user.role=='user'" :href="route('dashboard')">
                                    <ApplicationLogo
                                        class="block h-9 w-auto fill-current text-emerald-800"
                                    />
                                </Link>
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink v-if="user.role=='teacher'" :href="route('teacher.dashboard')" :active="route().current('teacher.dashboard')">
                                    Кабинет
                                </NavLink>
                                <NavLink v-if="user.role=='user'" :href="route('dashboard')" :active="route().current('dashboard')">
                                    Кабинет
                                </NavLink>
                                ...
                                <NavLink v-if="user.role=='teacher'" :href="route('results.index')" :active="route().current('results.index')">
                                    Результаты
                                </NavLink>
                            </div>
                        </div>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink v-if="user.role=='teacher'" :href="route('teacher.dashboard')" :active="route().current('teacher.dashboard')">
                            Кабинет
                        </ResponsiveNavLink>
                        <ResponsiveNavLink v-if="user.role=='user'" :href="route('dashboard')" :active="route().current('dashboard')">
                            Кабинет
                        </ResponsiveNavLink>
                        ...
                        <ResponsiveNavLink v-if="user.role=='teacher'" :href="route('results.index')" :active="route().current('results.index')">
                            Результаты
                        </ResponsiveNavLink>
                    </div>
